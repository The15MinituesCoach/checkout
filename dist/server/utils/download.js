 ...
 */
export function generateDownloadToken(productId, customerEmail, filePath, expirationHours = 24) {
 ...
 */
export function generateDownloadUrl(productId, customerEmail, baseUrl) {
