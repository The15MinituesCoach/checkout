...
const CheckoutForm = ({ paymentIntentId }: CheckoutFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
   await apiRequest("POST", "https://checkout-api-pcz0.onrender.com/create-payment-intent", {
        customerName: name,
        customerEmail: email,
...
export default function Checkout() {
  ...
  useEffect(() => {
    ...
    apiRequest("POST", "https://checkout-api-pcz0.onrender.com/create-payment-intent", {
      productId: "narcissism-survival-guide",
    })
      .then((res) => res.json())
      .then((data) => {
