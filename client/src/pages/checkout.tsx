...
export default function Checkout() {
  ...
  if (!clientSecret || !stripePromise || isLoading) {
    return (
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="text-xs text-neutral-darker mt-1">We'll email your receipt and download link.</p>
        </div>
      </div>
      ...
      <Button
        ...
        className={`w-full ${(!stripe || isLoading) ? "opacity-50 cursor-not-allowed" : ""}`}
      >
