            ...
            <div className="relative my-4 max-w-lg mx-auto">
              <div className="relative bg-white py-3 px-4 border-2 border-gray-300 rounded-md text-center shadow-md">
                ...
                <p className="font-serif">
                  ...
                  <br/>
                  <span className="text-accent-dark font-black text-xl">Mental Health & Trauma Research Center</span>
                </p>
          ...
          <div className="relative flex flex-col h-full">
            <div className="flex flex-col space-y-5 items-center mt-4">
              <div className="relative inline-block mb-1">
               <Badge variant="secondary" className="relative z-10 inline-block px-4 py-2 bg-gradient-to-r from-purple-600 via-red-500 to-purple-600 text-white rounded-lg font-bold text-sm shadow-lg animate-pulse border-2 border-white whitespace-nowrap">
