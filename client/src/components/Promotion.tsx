        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-primary/20 to-secondary/20 p-8 md:p-12 rounded-2xl shadow-lg backdrop-blur-sm border border-white/20 relative overflow-hidden">
            ...
            <div className="text-center">
             ...
             <Link href="/checkout">
  <button className="w-full pill-button bg-gradient-to-r from-accent to-secondary text-white py-4 px-8 font-medium transition-all duration-300 shadow-md hover:shadow-lg hover:scale-[1.02] pulse-animation">
