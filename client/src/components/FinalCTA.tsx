  ...
  return (
    <section className="py-16 bg-gradient-to-br from-primary/20 to-secondary/20 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
       ...
       <Link href="/checkout">
  <button className="w-full pill-button bg-gradient-to-r from-accent to-secondary text-white py-4 px-6 font-medium transition-all duration-300 shadow-md hover:shadow-lg hover:scale-[1.02] pulse-animation">
    ...
    <span className="sm:hidden">YES, GET SYSTEM NOW - $29</span>
          ...
          <Card className="mt-10 border-2 border-red-500 shadow-lg p-8 rounded-lg bg-red-50 relative overflow-hidden">
           ...
           <Link href="/checkout">
  <button className="w-full md:w-3/4 pill-button bg-gradient-to-r from-red-500 to-accent text-white py-4 px-6 font-bold transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-[1.02] pulse-animation">
    Get Instant Access
  </button>
</Link>
