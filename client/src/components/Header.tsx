      ...
      <div className="container-custom py-4">
        <div className="flex justify-between items-center">
          <div className="text-xl font-heading font-bold">
            ...
            <div className="md:hidden flex flex-col relative basis-0 flex-grow">
              <div className="absolute inset-0 bg-gradient-to-r from-primary via-secondary to-accent blur-lg opacity-30 rounded-lg transform scale-105"></div>
              <div className="relative bg-white/90 backdrop-blur-sm border border-white/50 rounded-lg px-6 py-4 shadow-md w-full">
                <div className="flex flex-col space-y-1 text-center w-full">
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent animate-pulse-subtle font-bold text-xl sm:text-2xl leading-tight">
                    Narcissism Survival Guide
                  </span>
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent animate-pulse-subtle text-base sm:text-lg leading-tight">
